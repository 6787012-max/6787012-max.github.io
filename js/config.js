// תצורה ציבורית. ה-anon key מוגן ע"י RLS — אין בו סוד.
window.CFG = {
  ...
  line: '0772251404',   // הקו הטלפוני (שלוחה 14) — הוחזר 04/09: 0772521358 שייך לסוכן הקולי, לא לגמ"ח
  ext:  '14',            // שלוחת מרכז הגמ"חים
  yishuv: 'מעלה עמוס'
};
